...
/**
 * Recorre recursivamente una ruta buscando SKILL.md y devuelve cada uno
 * con su frontmatter parseado.
 */
...
/**
 * Vigila cambios en los directorios de skills y resincroniza automáticamente.
 */
